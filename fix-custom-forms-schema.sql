-- Drop existing custom forms tables if they exist
DROP TABLE IF EXISTS custom_form_access;
DROP TABLE IF EXISTS custom_form_submissions;
DROP TABLE IF EXISTS custom_form_fields;
DROP TABLE IF EXISTS custom_forms;

-- Create custom_forms table with all required columns
CREATE TABLE custom_forms (
    ...
    submission_expiry_days INT NULL,
...
-- Create custom_form_submissions table
...
-- Create custom_form_access table
CREATE TABLE custom_form_access (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    form_id BIGINT NOT NULL,
    lead_id BIGINT NULL,
    contact_id BIGINT NULL,
